...
webpack5 作为打包工具，还提供了很多优化性能的功能。本文将介绍 webpack5 优化性能的一些方法。
...
代码分割实现有不同的方式，为了更加方便体现它们之间的差异，我们会分别创建新的文件来演示。

### 多入口文件

#### 直接拆分入口文件

5 大核心中的 entry 配置多个入口文件，webpack 会自动生成多个 bundle 文件。
...
- 运行指令
  ...
  在没配置代码分割之前，配置了几个入口，就输出几个 js 文件。
