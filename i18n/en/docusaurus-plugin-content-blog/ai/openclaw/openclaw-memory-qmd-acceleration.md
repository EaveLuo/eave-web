...
tags:
  ...
  - openclaw
description: >-
  A deep dive into OpenClaw's QMD memory retrieval backend, exploring how the
  hybrid architecture of BM25 + vector search + LLM reranking achieves 10x
  retrieval efficiency improvements, and how to deploy this powerful memory
  system locally.
title: 'OpenClaw Memory Retrieval Acceleration: QMD Deep Dive'
---
