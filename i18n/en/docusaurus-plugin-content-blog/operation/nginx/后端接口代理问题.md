---
slug: /operation/nginx/api-proxy-problem
...
description: >-
  Nginx reverse proxy configuration solving cross-domain and API forwarding
  issues in frontend-backend separated deployment, including proxy_pass, headers
  setting, load balancing and other configurations.
authors:
  - eave
