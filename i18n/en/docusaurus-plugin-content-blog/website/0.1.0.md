...
description: >-
  ...
  Everything is prepared, and nothing is prepared Version 0.1.0: Content
---
...
- [x] Complete three articles in [Operation and Maintenance](/blog/tags/operations)

- [x] [Login to the host via SSH key](/blog/operation/linux/ssh-key-login-host)

- [x] [History routing problem](/blog/operation/nginx/history-router-problem)

- [x] [Backend interface proxy problem](/blog/operation/nginx/api-proxy-problem)
